...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/sellerlogo.png" type="image/x-icon" />
        ...
        <div class="top-header">
            ...
            ?>
                ...
                <div class="rightbox">
                    <ul>
                        <li>
                            <a href="seller/index.php" class="rightlink">
                            <i class="uil uil-user-circle bg"></i>
                                Seller Login
                            </a>
                        </li>
                        <li>
                            <a href="admin/login.php" class="rightlink">
                            <i class="uil uil-user-circle bg"></i>
                                Admin Login
                            </a>
                        </li>
